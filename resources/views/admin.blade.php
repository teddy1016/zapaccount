        ...
        <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              <img src="{{ asset('assets/images/logo.png') }}" alt="Zapaccount Admin Page" width="50"/>
              <h1 class="btn me-2 buy-now-btn border-0">Admin Dashboard</h1>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
            ...
            <a class="dropdown-item" href="{{ route('logout') }}"
              ...
              ><i class="mdi mdi-logout text-white me-0"></i>
            </a>
